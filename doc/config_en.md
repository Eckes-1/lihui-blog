...
:::tip
For the backend project, refer to [lihui-blog](https://github.com/Eckes-1/momo-blog). Ensure all configurations are completed as specified, particularly for cross-domain domains.
:::
