    ...
    const nScript = h(
        ...
        (function() {
            const initMusicCard = () => {
                ...
                fetch('https://api.injahow.cn/meting/?server=netease&type=detail&id=${songId}', { referrerPolicy: "no-referrer" })
                    ...
                    .then(data => {
                        if (data && data.id) {
                            ...
                            if (coverEl) {
                                fetch('https://api.injahow.cn/meting/?server=netease&type=pic&id=${songId}', { referrerPolicy: "no-referrer" })
                                    .then(res => res.json())
                                    .then(coverData => {
